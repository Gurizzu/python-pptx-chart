...
run.text = 'BAR CLUSTERED MODIFIED'
...
run.text = 'BAR STACKED 100 MODIFIED'



# Simpan presentasi
prs.save(R'src\charts\result\bar.pptx')                        
os.startfile(R'src\charts\result\bar.pptx')
