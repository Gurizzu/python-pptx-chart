...
run.text = 'AREA STACKED MODIFIED'
...
chart = slide3.shapes.add_chart(
    XL_CHART_TYPE.AREA_STACKED_100, x, y, cx, cy, chart_data
).chart
...
run.text = 'AREA STACKED 100 MODIFIED'



# Simpan presentasi
prs.save(R'src\charts\result\area.pptx')                        
os.startfile(R'src\charts\result\area.pptx')
